...
class Program {
    ...
    static void MatrixCode() {
        ...
        Matrix<Int32> A = new Matrix<Int32>(4, 4);
        A[1, 1] = 1; A[1, 2] = 2; A[1, 3] = 1; A[1, 4] = 2;
        A[2, 1] = 1; A[2, 2] = 2; A[2, 3] = 1; A[2, 4] = 2;
        A[3, 1] = 1; A[3, 2] = 2; A[3, 3] = 1; A[3, 4] = 2;
        A[4, 1] = 1; A[4, 2] = 2; A[4, 3] = 1; A[4, 4] = 2;
        
        Matrix<Int32> B = new Matrix<Int32>(4, 4);
        B[1, 1] = 2; B[1, 2] = 1; B[1, 3] = 2; B[1, 4] = 1;
        B[2, 1] = 2; B[2, 2] = 1; B[2, 3] = 2; B[2, 4] = 1;
        B[3, 1] = 2; B[3, 2] = 1; B[3, 3] = 2; B[3, 4] = 1;
        B[4, 1] = 2; B[4, 2] = 1; B[4, 3] = 2; B[4, 4] = 1;
